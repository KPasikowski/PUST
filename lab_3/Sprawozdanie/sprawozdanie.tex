...
\chapter{Zad. 2}
Skroœne odpowiedzi skokowe czujnika $ T1 $ i grza³ki $ G2 $ zosta³y przedstawione na wykresie ~\ref{zad2_odpskok} Skoki sterowania wynosi³y odpowiednio:
\begin{itemize}
...
\begin{figure}[b]
	...
	\caption{Skroœne odpowiedzi skokowe dla ró¿nych skoków sterowania grza³ki $ G2 $ }
	\label{zad2_odpskok}
\end{figure}
...
$$ K_{st} = \frac{\Delta y}{\Delta u} \approx \num{0.19}$$
