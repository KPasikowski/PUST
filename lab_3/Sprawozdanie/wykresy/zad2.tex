...
\addplot[const plot,color=red,semithick] file {datadir/T2_G1_49.txt};
\addplot[const plot,color=green,semithick] file {datadir/T2_G1_69.txt};
\legend{$G1 = 39$,$G1 = 49$,$G1 = 69$}
\end{groupplot}
\end{tikzpicture}
\end{figure}
...
xlabel={$G$}]
	...
	\legend{ $T_1(G_1)$, $T_2(G_1)$, $T_1(G_2)$, $T_2(G_2)$ }
\end{groupplot}
\end{tikzpicture}
\end{figure}
