...
\begin{figure}[b]
	...
	\caption{Dochodzenie uk³adu do punktu pracy przy sterowaniu $ u = 50 \quad z = 0$}
	\label{zad1_punkt_pracy}
\end{figure}

\chapter{Zad. 2}
Odpowiedzi skokowe toru zak³ócenie-wyjœcie dla trzech ró¿nych zmian zak³ócenia zosta³y przedstawione na wykresie ~\ref{zaklocenia}. Skoki zak³ócenia wynosi³y odpowiednio:
\begin{itemize}
	\item {\color{red} $ z = 10 $}
	\item {\color{blue} $ z = 15 $}
	\item {\color{green} $ z = 30 $}
\end{itemize}
\begin{figure}[b]
	\centering
...
W³aœciwoœci statyczne obiektu mo¿na okreœliæ jako liniowe, gdy¿ zmiana zak³ócenia powoduje liniow¹ zmianê sygna³u wyjœciowego. Charakterystyka statyczna toru zak³ócenie-wyjœcie zosta³a przedstawiona na wykresie ~\ref{char_stat_z}
\begin{figure}[b]
	\centering
...
S = S(32:end);
\end{lstlisting}
Dokonano tu dzielenia przez $ 30 $, gdy¿ o tak¹ wartoœæ zosta³o zmienione zak³ócenie. 
