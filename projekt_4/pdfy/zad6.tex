...
\begin{figure}[DMC]
\tikzsetnextfilename{zad6DMC_LR2}
\begin{tikzpicture}
...
\begin{figure}[DMC]
\tikzsetnextfilename{zad6DMC_LR3}
\begin{tikzpicture}
\begin{groupplot}[group style={group size=1 by 2,vertical sep=\odstepionowy},
width=\szer,height=\wys]
%%1
...
\begin{figure}[DMC]
\tikzsetnextfilename{zad6DMC_LR4}
\begin{tikzpicture}
\begin{groupplot}[group style={group size=1 by 2,vertical sep=\odstepionowy},
width=\szer,height=\wys]
%%1
...
\begin{figure}[DMC]
\tikzsetnextfilename{zad6DMC_LR5}
\begin{tikzpicture}
\begin{groupplot}[group style={group size=1 by 2,vertical sep=\odstepionowy},
width=\szer,height=\wys]
%%1
...
\nextgroupplot
[xmin=1,xmax=800,ymin=-5,ymax=2,
xtick={0,50,...,800},
ytick={-5,-4,...,2},
ylabel={$y(k)$},
xlabel={$k$}]
\addplot[const plot,color=red,semithick] file {datadir/zad6/odpowiedzi/wyjscie_skok_-1_0.75.txt};
\legend{$y(k)$};
\end{groupplot}
\end{tikzpicture}
\end{figure}
