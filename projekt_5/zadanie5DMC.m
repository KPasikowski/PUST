...
zapiszDoPliku([subDirPathDMC '/zad5DMC_yzad1.txt'], yzad(1,:));
zapiszDoPliku([subDirPathDMC '/zad5DMC_yzad2.txt'], yzad(2,:));
zapiszDoPliku([subDirPathDMC '/zad5DMC_yzad3.txt'], yzad(3,:));
zapiszDoPliku([subDirPathDMC '/zad5DMC_y1.txt'], y(1,:));
zapiszDoPliku([subDirPathDMC '/zad5DMC_y2.txt'], y(2,:));
zapiszDoPliku([subDirPathDMC '/zad5DMC_y3.txt'], y(3,:));
zapiszDoPliku([subDirPathDMC '/zad5DMC_u1.txt'], u(1,:));
zapiszDoPliku([subDirPathDMC '/zad5DMC_u2.txt'], u(2,:));
zapiszDoPliku([subDirPathDMC '/zad5DMC_u3.txt'], u(3,:));
zapiszDoPliku([subDirPathDMC '/zad5DMC_u4.txt'], u(4,:));